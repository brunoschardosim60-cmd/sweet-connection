...
export function instrucoesDoPlano(entrada: EntradaPlano) {
  ...
  return [
    ...
    "FAQ, SEO e descrições também devem respeitar os dados confirmados. Não afirme que agendamento, pagamento online, entrega ou pedido pelo site já estão habilitados: o objetivo do briefing não comprova configuração operacional. Para combinar retirada ou encomenda, oriente a entrar em contato com o estabelecimento, sem prometer confirmação automática, prazo ou disponibilidade.",
    cardapio
