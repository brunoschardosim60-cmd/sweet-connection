-- Harden public form ingestion and centralize anonymous analytics.
...
begin
  ...
  fingerprint_digest := case
    ...
    else encode(digest(left(fingerprint, 500), 'sha256'), 'hex')
  end;
...
begin
  ...
  session_digest := case
    ...
    else encode(digest(left(session_fingerprint, 500), 'sha256'), 'hex')
  end;
