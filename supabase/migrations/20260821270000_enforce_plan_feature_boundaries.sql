-- The free tier can build a complete draft. Publication is the only point where
-- commercial limits apply, and every check is made server-side.
...
begin
  ...
  -- Essencial is a professional link page: contact, basic form, hours, map and QR.
  ...
  -- Products, a digital menu, promotions and checkout operations are Catalog features.
